...
KERNEL_OPTIONS += -DSCROLLING=0 -DTRANSLUCENT_COLOR=0x00 -DRAM_TILES_COUNT=32 -DMAX_SPRITES=10 -DTRUE_RANDOM_GEN=1
...
OBJECTS += graphics.o system.o gamesys.o background.o bullet.o player.o invader.o main.o
